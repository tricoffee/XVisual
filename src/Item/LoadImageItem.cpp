...
{
	QString defaultPath = lastImagePath.isEmpty() ? QDir::homePath() : lastImagePath;
	...
	if (!imagePath.isEmpty())
	{
		...
		//LoadImageHandle* loadHandle = dynamic_cast<LoadImageHandle*>(xHandle);
		//Source& s = loadHandle->getSources();
...
void LoadImageItem::createUniqueName(const QString& classNameQStr)
{
